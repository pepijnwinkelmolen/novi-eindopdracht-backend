    ...
    protected SecurityFilterChain filter (HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/profile/{id}").hasAnyRole("ADMIN", "USER")
                    ...
                    .requestMatchers(HttpMethod.POST,"/advertisements").hasAnyRole("ADMIN", "USER")
                    .requestMatchers("/advertisements/search").permitAll()
                    .requestMatchers("/advertisements/filter").permitAll()
                    .requestMatchers(HttpMethod.POST,"/bids/{value}/advertisement/{id}").hasAnyRole("ADMIN", "USER")
